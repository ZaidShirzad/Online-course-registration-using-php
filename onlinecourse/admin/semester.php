 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">سیمستر  </h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="semester">ایجاد سیمستر  </label>
    <input type="text" class="form-control" id="semester" name="semester" placeholder="سیمستر" required />
  </div>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
  <a href="semester.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('آیا مطمین هستید?')">
