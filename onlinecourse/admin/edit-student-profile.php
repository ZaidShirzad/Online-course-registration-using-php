...
if($ret)
{
echo '<script>alert("ریکورد شاگرد به شکل موفقانه اپدیت شد !!")</script>';
echo '<script>window.location.href=manage-students.php</script>';
}else{
  echo '<script>alert("Error : ریکورد اپدیت نشد")</script>';
echo '<script>window.location.href=manage-students.php</script>';
}
}
?>
...
<div class="form-group">
    <label for="studentphoto">انتخاب عکس جدید  </label>
 ...
 <button type="submit" name="submit" id="submit" class="btn btn-default">تغییر</button>
</form>
                            </div>
                            </div>
                    </div>
