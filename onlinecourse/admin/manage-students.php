...
<a href="manage-students.php?id=<?php echo $row['StudentRegno']?>&del=delete" onClick="return confirm('آیا مطمین استید?')">
                                            <button class="btn btn-danger">حذف</button>
</a>
<a href="manage-students.php?id=<?php echo $row['StudentRegno']?>&pass=update" onClick="return confirm('آیا مطمین استید?')">
<button type="submit" name="submit" id="submit" class="btn btn-default">تغییر پسورد</button>
</a>
                                            </td>
                                        </tr>
<?php 
