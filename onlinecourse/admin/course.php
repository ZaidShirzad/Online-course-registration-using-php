...
echo '<script>alert("Error : کورس ساخته نشده است!!")</script>';
echo '<script>window.location.href=course.php</script>';
}
}
...
echo '<script>alert("کورس حذف شد!!")</script>';
echo '<script>window.location.href=course.php</script>';
      }
?>
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="coursecode">کود نمبر کورس  </label>
    <input type="text" class="form-control" id="coursecode" name="coursecode" placeholder="کود نمبر کورس" required />
  </div>

 <div class="form-group">
    <label for="coursename">نام کورس  </label>
    <input type="text" class="form-control" id="coursename" name="coursename" placeholder="نام کورس" required />
  </div>

<div class="form-group">
    <label for="courseunit">واحد کورس  </label>
    <input type="text" class="form-control" id="courseunit" name="courseunit" placeholder="واحد کورس" required />
  </div> 

<div class="form-group">
    <label for="seatlimit">محدودیت چوکی  </label>
    <input type="text" class="form-control" id="seatlimit" name="seatlimit" placeholder="محدودیت چوکی " required />
  </div>   
...
<button class="btn btn-primary"><i class="fa fa-edit "></i> ایدیت</button> </a>                                        
